...
namespace HotelReservationSystem.Migrations
{
    ...
    [Migration("20241010184955_fixPool")]
    partial class fixPool
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelReservationSystem.Models.Pool", b =>
                {
            ...
            modelBuilder.Entity("HotelReservationSystem.Models.ReservePool", b =>
                {
                    b.Property<int>("ReservePoolId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReservePoolId"), 1L, 1);
                    ...
                    b.HasKey("ReservePoolId");

                    b.HasIndex("PoolId");

                    b.HasIndex("UserId");

                    b.ToTable("ReservePools");
                });
            ...
            modelBuilder.Entity("HotelReservationSystem.Models.ReservePool", b =>
                {
                    b.HasOne("HotelReservationSystem.Models.Pool", "Pool")
                        .WithMany()
